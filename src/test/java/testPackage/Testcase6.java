...
WebDriverManager.chromedriver().setup();
    ...
    // Thread.sleep(3000);
		...
		//Case6 locate webelement via Parent to child traverse using Xpath
		driver.findElement(By.xpath("//div[@class='forgot-pwd-btn-conainer']/button[1]")).click();
		
		driver.findElement(By.cssSelector("input#inputUsername")).sendKeys("rahul");
		//Generate CSS Selector using Regular Expressions: tagname[attributename*=‘partialvalue’]                       
		driver.findElement(By.cssSelector("input[type*='pass']")).sendKeys("rahulshettyacademy");
		//checked both the checkboxes
		driver.findElement(By.id("chkboxOne")).click();
		driver.findElement(By.cssSelector("input[value*='agree']")).click();
		//Generate Xpath using Regular Expressions://tagname[contains(@attributename,’partialattributevalue’)]
